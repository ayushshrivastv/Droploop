...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    ...
    <section 
      className="relative w-full h-screen overflow-hidden hero-section-main-container -mt-16" // Added negative margin to pull up under header
      style={{ backgroundColor: 'transparent' }} // Changed to transparent to blend with header
    ...
    >
      ...
      {/* Particles container - increased z-index for particles to be visible above header */}
      <div 
        ref={particlesContainerRef}
        className="absolute top-0 left-0 w-full h-full overflow-hidden z-[5] pointer-events-none"
      ...
      {/* Content - z-index 20 - changed to pt-16 to account for header height */}
