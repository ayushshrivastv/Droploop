        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 justify-items-center">
          ...
          <div className="flex flex-col items-center">
            ...
            <ul className="space-y-2 text-center">
              ...
              <li>
                <Link href="https://github.com/ayushshrivastv/Droploop.git/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-white transition-colors">
                  MIT License
                </Link>
              </li>
            </ul>
