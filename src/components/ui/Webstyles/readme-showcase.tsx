      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl">
        ...
        >
          ...
          <p className="text-zinc-300 text-lg max-w-2xl mx-auto font-serif">
            Technical details about the Droploop implementation
          </p>
        </motion.div>
        ...
        <div className="space-y-12">
          ...
          >
            ...
            <p className="text-zinc-200 text-lg leading-relaxed mb-10">
              Droploop supports <span className="text-blue-300 font-medium">Concurrent Minting</span>, enabling parallel token issuance without chain congestion—a critical feature for high-volume events. Despite the compression techniques employed, tokens maintain <span className="text-blue-300 font-medium">Verifiable Ownership</span> with full composability with other Solana protocols, ensuring they function seamlessly within the broader ecosystem.
            </p>

            <h3 className="text-2xl font-bold text-white mb-6 text-center mt-12">Scalability Highlights</h3>
            
            <p className="text-zinc-200 text-lg leading-relaxed mb-6">
              The scalability advantages of our approach are substantial. Droploop delivers <span className="text-blue-300 font-medium">Massive Throughput</span>, capable of supporting events with 10,000+ attendees through Light Protocol's compressed NFTs. This represents a transformative improvement over traditional methods that struggle with even modest distribution volumes.
            </p>
