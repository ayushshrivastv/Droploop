...
async function getAnalyticsData(publicKey: string | PublicKey | null, timeframe: 'week' | 'month' = 'week'): Promise<AnalyticsData | null> {
  ...
  return {
    ...
    topEvents: [
      { name: 'Droploop Demo', tokensIssued: 0, tokensClaimed: 0, conversionRate: 0 }
    ],
    recentActivity: []
  };
}
...
export function ClaimAnalytics() {
  ...
  // fetchAnalyticsData is now defined above using useCallback
